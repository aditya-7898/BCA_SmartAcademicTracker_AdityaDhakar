...
export default function StudentSidebar({ sidebarOpen }) {
  const menu = [
    ...
    { name: "Attendance", icon: <CalendarDays size={20} />, path: "/student/attendance" },
    { name: "Marks", icon: <BarChart3 size={20} />, path: "/student/marks" },
    { name: "Performance", icon: <TrendingUp size={20} />, path: "/student/performance" },
    { name: "Admit Card", icon: <Ticket size={20} />, path: "/student/admit-card" },
    { name: "Forms", icon: <FileText size={20} />, path: "/student/forms" },
    { name: "Results", icon: <ClipboardList size={20} />, path: "/student/results" },
    { name: "Raise Issue", icon: <AlertCircle size={20} />, path: "/student/issue" },
    { name: "Training", icon: <GraduationCap size={20} />, path: "/student/training" },
    { name: "Calendar", icon: <Calendar size={20} />, path: "/student/calendar" },
    ...
    { name: "Feedback", icon: <MessageSquare size={20} />, path: "/student/feedback" },
  ];
