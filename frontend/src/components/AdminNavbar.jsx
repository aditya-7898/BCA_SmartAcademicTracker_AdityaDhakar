...
export default function AdminNavbar({ sidebarOpen, setSidebarOpen }) {
  ...
  const notifications = [
    { id: 1, text: "New student registered", time: "2 min ago" },
    { id: 2, text: "Exam form submitted", time: "10 min ago" },
    { id: 3, text: "Issue raised by student", time: "30 min ago" },
  ];
  ...
  return (
    <div className="h-16 backdrop-blur-md bg-white/70 shadow-lg flex items-center justify-between px-6 border-b">
